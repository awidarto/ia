                            ...
                            <div class="row">
                                <div class="images span9">
                                    <div class='iosSlider'>
                                        <div class='slider-content'>
                                            <div class="slide">
                                                <img src="{{ URL::to('/') }}/realia/img/tmp/property-large-1.jpg" alt="">
                                            ...
                                            <div class="slide">
                                                <img src="{{ URL::to('/') }}/realia/img/tmp/property-large-2.jpg" alt="">
                                            ...
                                            <div class="slide">
                                                <img src="{{ URL::to('/') }}/realia/img/tmp/property-large-3.jpg" alt="">
                                ...
                                <div class="span3">
                                    <div class="property-filter">
                                        <div class="content">
                                            <form method="get" action="http://html.realia.byaviators.com/index-slider.html?">
