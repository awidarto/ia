...
<meta content="wkXJXEQByv0cc4a/cUKecb5ulmjnu6DKyidbyG+zGxc=" name="csrf-token" />
...
<div class="commandbar">
  ...
  <input type="text" data-hotkey="/ s" name="q" id="js-command-bar-field" placeholder="Search or type a command" tabindex="1" autocapitalize="off"
    ...
    data-username="awidarto"
      ...
      data-branch="master"
      data-sha="66a55160dc4d82fcdcd6fa9660fbe7eb4e9e7c95"
  >
  ...
  <ul id="user-links">
    <li>
      <a href="/awidarto" class="name">
        <img alt="Andy Awidarto" class=" js-avatar" data-user="339859" height="20" src="https://avatars2.githubusercontent.com/u/339859?s=140" width="20" /> awidarto
      </a>
    </li>
...
<div class="container">
    ...
    <p>You can contact <a href="mailto:support@github.com">support@github.com</a> with any questions.</p>
      <p>
        We'll try billing your account again on January 30, 2014.
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="wkXJXEQByv0cc4a/cUKecb5ulmjnu6DKyidbyG+zGxc=" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="1863329" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <a href="/laravel/laravel/unstar"
      ...
      aria-label="Unstar this repository" title="Unstar laravel/laravel" data-remote="true" data-method="post" rel="nofollow">
      <span class="octicon octicon-star-delete"></span><span class="text">Unstar</span>
    </a>

    <a href="/laravel/laravel/star"
      class="minibutton with-count js-toggler-target star-button unstarred"
      aria-label="Star this repository" title="Star laravel/laravel" data-remote="true" data-method="post" rel="nofollow">
      ...
      <a class="social-count js-social-count" href="/laravel/laravel/stargazers">
        ...
        <li>
          <a href="/laravel/laravel/fork" class="minibutton with-count js-toggler-target fork-button lighter tooltipped-n" title="Fork your own copy of laravel/laravel to your account" aria-label="Fork your own copy of laravel/laravel to your account" rel="nofollow" data-method="post">
            <span class="octicon octicon-git-branch-create"></span><span class="text">Fork</span>
          </a>
          <a href="/laravel/laravel/network" class="social-count">2,986</a>
        </li>
...
<div class="clone-url "
  ...
  <div class="clone-url-box">
    ...
    <span aria-label="copy to clipboard" class="js-zeroclipboard url-box-clippy minibutton zeroclipboard-button" data-clipboard-text="git@github.com:laravel/laravel.git" data-copied-hint="copied!"><span class="octicon octicon-clippy"></span></span>
  </div>
</div>
...
<p class="clone-options">You can clone with
  ...
  <a href="http://mac.github.com" data-url="github-mac://openRepo/https://github.com/laravel/laravel" class="minibutton sidebar-button js-conduit-rewrite-url" title="Save laravel/laravel to your computer and use it in GitHub Desktop." aria-label="Save laravel/laravel to your computer and use it in GitHub Desktop.">
